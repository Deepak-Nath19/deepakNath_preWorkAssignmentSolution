...
public class Main {
		...
		do
		{
			...
			if(sc.hasNextInt())
			{
				...
				if(number >= 0) {
					...
					correctInput = false;
					System.out.println("you are expected to enter a positive integer");
				}
				
			}else
			{
				correctInput = false;
				System.out.println("you are expected to enter an integer value "); // between o to 2147483647.
				sc.nextLine();
				System.out.println();
			}
		}while(!correctInput);
	...
	public void printPattern() {
		...
		String msg = "Enter the number to print star pattern in decreasing order. ";
	...
	public void printFibonacciSeries() {
		...
		String msg = "Enter the number to print Fibonacci Series. ";
